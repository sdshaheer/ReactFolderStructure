...
const pdf_preview_1 = require("./pdf-preview");
class PdfEditorProvider {
    ...
    resolveCustomEditor(document, webviewEditor) {
        return __awaiter(this, void 0, void 0, function* () {
            const preview = new pdf_preview_1.PdfPreview(this.extensionRoot, document.uri, webviewEditor);
...
//# sourceMappingURL=pdf-editor-provider.js.map