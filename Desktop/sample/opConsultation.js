...
const opConsultationResponse = {
    "resourceType": "Bundle",
    "id": "2efc8643-743b-4559-9030-f07456970711",
    "meta": {
        "lastUpdated": "2023-08-31T12:55:19.590130Z"
    },
    "identifier": {
    ...
    "type": "document",
    "timestamp": "2023-08-31T12:55:19.590130Z",
    "entry": [
        {
            ...
            "resource": {
                ...
                "date": "2023-08-31T12:55:19.590130Z",
                "author": [
                    {
        ...
        },
        {
            ...
            "resource": {
                ...
                "period": {
                    "start": "2023-08-31T12:55:19.590130Z"
                }
            }
        },
        {
            ...
            "resource": {
                ...
                "recordedDate": "2023-08-31T12:55:19.590130Z"
            }
        },
        {
        ...
        },
        {
            ...
            "resource": {
                ...
                "effectiveDateTime": "2023-08-31T12:55:19.590130Z",
                "valueQuantity": {
                    "value": 99.5,
                    "unit": "C"
                }
        ...
        },
        {
            ...
            "resource": {
                ...
                "authoredOn": "2023-08-31T12:55:19.590130Z",
                "requester": {
                    "reference": "Practitioner/MAX1234"
                },
                "dosageInstruction": [
        ...
        },
        {
            ...
            "resource": {
                ...
                "performedDateTime": "2023-08-31T12:55:19.590130Z",
                "asserter": {
                    "reference": "Practitioner/MAX1234"
                },
                "complication": [
        ...
        },
        {
            ...
            "resource": {
                ...
                "period": {
                    "start": "2023-08-31T12:55:19.590130Z",
                    "end": "2023-08-31T12:55:19.590130Z"
                },
                "author": {
                    "reference": "Practitioner/MAX1234"
                },
...
const itemsToLoop = opConsultationResponse.entry; //response.entry

var OutputObject = {};

const fetchopConsultationDetails = async () => {
    itemsToLoop.map((e) => {
