...
const prepareData = (details,summary,social_history,family_history,medicalHistory,surgicalHistory,medication,allergies) =>{
  console.log('details',medicalHistory)
  const data =  {
    user_information: {
      user_details: {
        name:details.name,  
...
const getData = async ()=>{
  try {
    ...
    querySnapshot2.forEach((doc) => {
     ...
     prepareData(details,summary,social_history,family_history,medicalHistory,surgicalHistory,medication,allergies)
...
//               start_date: "since Sep 2023",
//               comment: "rtrsewerwe"
//             },
//             {
//               problem_name: "High grade squamous intraepithelial lesion on cytologic smear of anus (HGSIL)",
//               start_date: "since Sep 2023",
//               comment: "test"
//             },
//             {
//               problem_name: "Helicobacter pylori [H. pylori] as the cause of diseases classified elsewhere",
//               start_date: "since Sep 2023",
//               comment: "test"
//             },
//           ],
...
//             },
//             {
//               problem_name: "Post COVID-19 condition, unspecified",
//               start_date: "since Sep 2020",
//               comment: "Post COVID-19 condition, unspecified"
//             },
//             {
//               problem_name: "Vaping-related disorder",
//               start_date: "since Jan 2010",
//               comment: "test AK inactive"
//             },
//             {
//               problem_name: "Anemia in chronic kidney disease",
//               start_date: "since Feb 1980",
//               comment: "sdsdfsfdsdfdf"
//             },
//           ]
//         },
//         surgical_history: {
//           active: [
//             {
//               problem_name: "Reposition Right Metatarsal , ",
//               start_date: "since Sep 2023",
//               comment: "test"
//             },
//             {
//               problem_name: "Repair Glomus Jugulare , , ",
//               start_date: "since Sep 2023",
//               comment: "test"
//             },
//           ],
//           inactive: [
//             {
//               problem_name: "Revision of Nonautologous Tissue Substitute in Left Humeral Shaft  ",
//               start_date: "since Aug 2023",
//               comment: "test"
//             },
//             {
//               problem_name: "Reposition Right Metatarsal ",
//               start_date: "since Feb 2018",
//               comment: "sadsadasjd askdkhh jasdasdjkhkajsdhjk ahskdasjhdkjhjkashdjkh asdhsjkalh dkjladh lakjhdk jasd ashdkl askdhkjashdjaskjdhkashdjkasdhj klashkljd haskhdklas"
//             },
...
//                                     {{#each roojh_summary.summary.medical_history_and_surgical_history.medical_history.active}}
...
//                                 </div>
//                                 <div class="wd100 body-sec">
//                                     {{#each roojh_summary.summary.medical_history_and_surgical_history.surgical_history.active}}
//                                       <div class="m-bottom10">
//                                           <div class=" dsp-flex">
//                                               <div class="key" style="width: 67%;">{{problem_name}}</div>
//                                               <div class="pd-top12">({{start_date}})</div>
...
//                                     {{#each roojh_summary.summary.medical_history_and_surgical_history.medical_history.inactive}}
//                                         <div class="m-bottom10">
//                                             <div class=" dsp-flex">
//                                                 <div class="key" style="width: 67%;">{{problem_name}}</div>
//                                                 <div class="pd-top12">({{start_date}})</div>
...
//                                 </div>
//                                 <div class="wd100 color-light-gray body-sec">
//                                     {{#each roojh_summary.summary.medical_history_and_surgical_history.surgical_history.inactive}}
//                                         <div class="m-bottom10">
//                                             <div class=" dsp-flex">
//                                                 <div class="key" style="width: 67%;">{{problem_name}} </div>
//                                                 <div class="pd-top12">({{start_date}})</div>
