...
const prepareData = (details, summary, social_history, family_history, medicalHistory, surgicalHistory, medication, allergies, documents) => {
  const data = {
    user_information: {
      user_details: {
        name: details.name,
...
const getData = async () => {
  try {
    ...
    return prepareData(details, summary, social_history, family_history, medicalHistory, surgicalHistory, medication, allergies, documents)
